...
<?php
$page = "Tell us all job position you have in your company";
$step = 'job positions'
?>
    ...
    <div class="container center-align valign getStartedContainer">
        ...
        <div class="col l10 offset-l1 s12 mb30">
            ...
            <div class="col l10 m10 s12 input-field">
                <input type="text" id="jobPosition" class="mb0 autocompleteCustom1">
        ...
        <input class="text_success" type="hidden" value="Step 4 is success. Moving to step 5..."/>
