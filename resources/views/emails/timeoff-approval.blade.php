...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #910111; padding-top: 30px;font-weight: bold" class="padding-copy">Time Off Request {{$var[2]}}</td>
                </tr>
                <tr>
                    <td align="center" style="text-align:center;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                            {{$receiver}}, Your Time Off request for<br>
                            <strong>{{$var[1]}}</strong><br><br>
