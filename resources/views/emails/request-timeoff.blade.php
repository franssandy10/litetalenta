...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #910111; padding-top: 30px;font-weight: bold" class="padding-copy">Time Off Request</td>
                </tr>
                <tr>
                    <td align="center" style="text-align:center;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy"> <strong>{{$name}}</strong> would like to request time off on this date:<br><br>
                    <strong>{{$datedesc}}</strong><br><br>
