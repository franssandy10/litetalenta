...
<div class="row mb0 h100vh valign-wrapper">
    <div class="container center-align valign getStartedContainer">
        ...
        {!! Form::open(array('url' => 'get-started-7','id'=>'getting-started-form')) !!}
          <div class="col l10 offset-l1 s12">
              ...
              <div class="col l6 m6 s12 input-field">
                <?= Form::text('tax_person_npwp','',array('id'=>'tax_person_npwp','class'=>'validate enter')) ?>
                <label for="tax_person_npwp">Tax Person NPWP</label>
              </div>
              <div class="col l6 m6 s12 input-field">
                <?= Form::text('company_npwp','',array('id'=>'company_npwp','class'=>'validate enter')) ?>
