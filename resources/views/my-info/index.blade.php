...
@section('customjs')
  {!! Html::script('assets/plugins/jquery.bxslider/jquery.bxslider.min.js')!!}
	...
	{!! Html::script('assets/js/scriptMyinfo.js')!!}
@endsection
...
<div class="container mt30 my-info">
	<div class="row">
      ...
      @yield('payrollDataHtml')
	    	...
	    	<div class="col l12 m12 s12">
	    		<div class="row mr0 ml0">
		    		<div class="col l12 m12 s12">
			    		...
			    		<a href="#modalRequestTimeOff" class="btn btnB01 left mt40 modal-trigger">Request time off</a>
		    		</div>
	    		</div>
		...
		<!-- Overtime
	    <div id="overtime" class="tab-content white">
	    	<div class="col l12 m12">
	    		<div class="row">
		    		<div class="col l12 m12 s12">
			    		<p class="titleC01 mb40 noBold mt30 left mr15">Overtime</p>
			    		<a href="#!" class="btn btnB01 left mt40">Request Overtime</a>
		    		</div>
	    		</div>


	    		<p class="titleC01 mb40 noBold mt30 mr15">Overtime Requested</p>
	    		<div class="col l12 m12 s12 tableWrap">
	    			<table class="bordered">
	    				<thead class="grey lighten-3 bold">
	    					<tr>
		...
		<!-- Delegation
	    <div id="delegation" class="tab-content white">
	    	<div class="col l12 m12 s12">
	    		<div class="row mr0 ml0">
		    		<div class="col l12 m12 s12">
			    		<p class="titleC01 mb40 noBold mt30 left mr15">Delegation</p>
			    		<a href="#!" class="btn btnB01 left mt40">Request Delegation</a>
		    		</div>
	    		</div>


	    		<p class="titleC01 mb40 noBold mt30 mr15">Delegation Requested</p>
	    		<div class="col l12 m12 s12 tableWrap">
	    			<table class="bordered">
	    				<thead class="grey lighten-3 bold">
	    					<tr>
	    ...
	    <!-- History
	    <div id="history" class="tab-content white">
			<div class="col l12 m12 s12">
	    		<div class="row mr0 ml0">
		    		<div class="col l12 m12 s12">
			    		<p class="titleC01 mb40 noBold mt30 left mr15">Your History</p>
		    		</div>
	    		</div>
				...
				<div class="row mt30 mr0 ml0">
				  	<div class="col l12 m12 s12">
				    	<ul style="width: 100%;" class="tabs my-info2 no-indicator">
				            <li class="tab col s3"><a href="#adjustmentHistory">ADJUSTMENT HISTORY</a></li>
				            <li class="tab col s3"><a href="#transferHistory">TRANSFER HISTORY</a></li>
				      	</ul>
				  	</div>
				</div>

				<div id="adjustmentHistory" class="col s12 pad-20 white">
					<div class="row">
						<p class="titleC01 mb40 noBold mt30 mr15">Adjustment History</p>
			    		<div class="col l12 m12 s12 tableWrap">
			    			<table class="bordered">
			    				<thead class="grey lighten-3 bold">
			    					<tr>
				...
				<div id="transferHistory" class="col s12 pad-20 white">
					<div class="row">
						<p class="titleC01 mb40 noBold mt30 mr15">Transfer History</p>
			    		<div class="col l12 m12 s12 tableWrap">
			    			<table class="bordered">
			    				<thead class="grey lighten-3 bold">
			    					<tr>
	    ...
	    <!-- Assets
	    <div id="assets" class="tab-content white">
			<div class="col l12 m12 s12">
	    		<div class="row mr0 ml0">
		    		<div class="col l12 m12 s12">
			    		<p class="titleC01 mb40 noBold mt30 left mr15">Assets</p>
			    		<a href="#!" class="btn btnB01 left mt40">Add Item</a>
		    		</div>
	    		</div>
