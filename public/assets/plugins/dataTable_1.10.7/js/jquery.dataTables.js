...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" id="search_' + tableId + '" class="'+classes.sFilterInput+'"/>';
		...
		var filter = $('<div/>', {
			...
			.append( $('<div class="input-field col s12 pad-r-n"/>' ).append(str).append('<label for="search_' + tableId + '">Search</label>') );
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div><div class="input-field col s12 pad-l-n"/></div>').addClass( classes.sLength );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sLengthMenu": "<label class='active'>Showing</label> _MENU_",
	...
	$.extend( DataTable.ext.classes, {
		...
		"sPageButton": "dataTable_pagination",
...
$(document).ready(function(){
	...
	$('body').on('blur', '.dataTables_filter input[type="search"]', function(){
		if($(this).val() == '') {
	...
	$('body').on('focus', '.dataTables_filter input[type="search"]', function(){
		$(this).parent().removeClass('innactive');
	});
	
	$('body').on('click', '.gotoPage', function(){
    $('.checkboxHeader').prop('checked',false);
	if ($('.goPagination input[type="number"]').val() != '') {
	...
	//untuk menghilangkan checkbox all jika pindah halaman
